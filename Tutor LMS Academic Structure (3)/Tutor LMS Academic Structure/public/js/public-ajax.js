(function($) {
    ...
    const TLMS_Public = {
        ...
        bindEvents: function() {
            ...
            $(document).on('submit', 'form.register, form#your-profile', this.validateForm.bind(this));
        },

        initializeRegistrationFields: function() {
            // Initialize if education type is already selected
        ...
        handleEducationTypeChange: function(e) {
            ...
            const $row = $('#tlms_academic_categories_row');
        ...
        validateForm: function(e) {
            ...
            // Only validate if academic fields are present
            if ($educationType.length) {
                ...
                // Validate category chain if not general
                if ($educationType.val() !== 'general') {
                    ...
                    $categorySelects.each(function() {
                        ...
                        if (!$select.val()) {
                            isValid = false;
                            TLMS_Public.showFieldError($select, 'Please select a ' + $select.find('option:first').text().toLowerCase());
                        }
                    });
