...
class TB_Metaboxes {
    public static function tb_register_course_metabox() {
        add_meta_box(
            'tb_subcategory_box',
            __( 'ÇáÊÕäíÝ ÇáÝÑÚí ÇáãÓÊåÏÝ', 'tutor-branching' ),
    ...
    public static function tb_render_subcategory_meta( $post ) {
        ...
        ?>
        <label for="tb_subcategory"><?php _e( 'ÇÎÊÑ ÊÕäíÝ ÝÑÚí', 'tutor-branching' ); ?></label>
        <select name="tb_subcategory" id="tb_subcategory" style="width:100%;">
            <option value=""><?php _e( 'ÇÎÊÑ ÊÕäíÝ ÝÑÚí', 'tutor-branching' ); ?></option>
